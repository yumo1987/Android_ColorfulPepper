...
public class TensorFlowYoloDetector implements Classifier {
  ...
  private static final int MAX_RESULTS = 5; //5

  //private static final int NUM_CLASSES = 20;
  private static final int NUM_CLASSES = 4;

  //private static final int NUM_BOXES_PER_BLOCK = 9; //5
  private static final int NUM_BOXES_PER_BLOCK = 9;

  // TODO(andrewharp): allow loading anchors and classes
  // from files.
  //private static final double[] ANCHORS = { //v1.2
  //  1.08, 1.19,
  //  3.42, 4.41,
  //  6.63, 11.38,
  //  9.42, 5.11,
  //  16.62, 10.52
  //};
  //private static final double[] ANCHORS = { //v3
  //        16,26,
  //        28,48,
  //        40,63,
  //        43,37,
  ...
  //        119,191
  //};
  private static final double[] ANCHORS = { //v3 tiny
          27,38,
          39,63,
          54,86,
          71,110,
  ...
  //};
  private static final String[] LABELS = {
          "0_pepper_flower","1_pepper_young","2_pepper_matured","3_pepper_covered"
  };
  ...
  public static Classifier create(
    ...
    d.outputNames = outputName.split(","); //conv_105/BiasAdd, op=BiasAdd
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    //final float[] output =
    //        //new float[gridWidth * gridHeight * (NUM_CLASSES + 3) * NUM_BOXES_PER_BLOCK];
    //        new float[(gridWidth * gridHeight * (NUM_CLASSES + 3) * NUM_BOXES_PER_BLOCK) * 3];
    //    //new float[gridWidth * gridHeight * (NUM_CLASSES + 3) * NUM_BOXES_PER_BLOCK];
    //inferenceInterface.fetch(outputNames[0], output);
    final float[] output =
            new float[gridWidth * gridHeight * (NUM_CLASSES + 3) * NUM_BOXES_PER_BLOCK * 500];
    for (int i = 0; i < 2; ++i) {
    ...
    for (int y = 0; y < gridHeight; ++y) {
        for (int x = 0; x < gridWidth; ++x) {
          for (int b = 0; b < NUM_BOXES_PER_BLOCK; ++b) {
            final int offset =
                    (gridWidth * (NUM_BOXES_PER_BLOCK * (NUM_CLASSES + 3))) * y
                            + (NUM_BOXES_PER_BLOCK * (NUM_CLASSES + 3)) * x
                            + (NUM_CLASSES + 3) * b;
